...
#ifndef MMROS__TENSORRT__PLUGIN__COMMON__TRT_CUDA_HELPER_HPP_
#define MMROS__TENSORRT__PLUGIN__COMMON__TRT_CUDA_HELPER_HPP_
...
#endif  // MMROS__TENSORRT__PLUGIN__COMMON__TRT_CUDA_HELPER_HPP_
