...
#ifndef MMROS__TENSORRT__PLUGIN__MODULATED_DEFORM_CONV__MODULATED_DEFORM_CONV_CPU_HPP_
#define MMROS__TENSORRT__PLUGIN__MODULATED_DEFORM_CONV__MODULATED_DEFORM_CONV_CPU_HPP_
...
{
template <typename T>
T bilinear_interpolate_2d(
  const T * src, const int64_t src_h, const int64_t src_w, const T h, const T w)
{
...
void deformable_im2col_2d(
  const T * input, const T * offset, const T * mask, const int64_t src_h, const int64_t src_w,
  ...
  const int64_t dilation_w, const int64_t channels, const int64_t offset_groups,
  const int64_t dst_h, const int64_t dst_w, const bool use_mask, T * columns)
{
...
#endif  // MMROS__TENSORRT__PLUGIN__MODULATED_DEFORM_CONV__MODULATED_DEFORM_CONV_CPU_HPP_
