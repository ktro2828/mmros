...
#include "mmros/tensorrt/plugin/gather_topk/gather_topk.hpp"
  ...
  cudaStream_t stream) TRT_NOEXCEPT
{
  ...
  auto nbDims = inputDesc[0].dims.nbDims;
  auto indice_nbDims = inputDesc[1].dims.nbDims;
...
nvinfer1::IPluginV2DynamicExt * GatherTopkCreator::createPlugin(
...
nvinfer1::IPluginV2DynamicExt * GatherTopkCreator::deserializePlugin(
