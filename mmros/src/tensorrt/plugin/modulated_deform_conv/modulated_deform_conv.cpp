...
#include "mmros/tensorrt/plugin/modulated_deform_conv/modulated_deform_conv.hpp"
...
static const nvinfer1::IDimensionExpr * get_hw(
  const nvinfer1::IDimensionExpr * input, const nvinfer1::IDimensionExpr * weight,
  const nvinfer1::IDimensionExpr * stride, const nvinfer1::IDimensionExpr * pad,
  const nvinfer1::IDimensionExpr * dilation, nvinfer1::IExprBuilder & exprBuilder)
{
  ...
  switch (data_type) {
    case nvinfer1::DataType::kFLOAT:
      ModulatedDeformConvForwardCUDAKernelLauncher<float>(
        (float *)x, (float *)weight, (float *)bias, (float *)offset, (float *)mask, (float *)output,
